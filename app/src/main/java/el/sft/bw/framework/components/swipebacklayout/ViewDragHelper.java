//
// from https://github.com/ikew0ng/SwipeBackLayout/blob/master/library/src/main/java/me/imid/swipebacklayout/lib/ViewDragHelper.java
//
...
public class ViewDragHelper {
    ...
    public static final int EDGE_SIZE = 3; // dp
     ...
     * callback's
     * {@link el.sft.bw.framework.components.swipebacklayout.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link el.sft.bw.framework.components.swipebacklayout.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link el.sft.bw.framework.components.swipebacklayout.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     */
    public boolean smoothSlideViewTo(View child, int left, int top) {
        mCapturedView = child;
        mActivePointerId = INVALID_POINTER;
     ...
     * {@link #continueSettling(boolean)} calls
     */
    private boolean forceSettleCapturedViewAt(int left, int top, int xvel, int yvel) {
        final int startLeft = mCapturedView.getLeft();
        final int startTop = mCapturedView.getTop();
        final int dx = left - startLeft;
        final int dy = top - startTop;
     ...
     * {@link el.sft.bw.framework.components.swipebacklayout.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
